    ...
    <div class="error-ops-panel">
        <div class="error-ops-panel__form">
            ...
            <header class="error-ops-panel__header">
                <div>
                    <span class="error-ops-panel__eyebrow">Error del sistema</span>
                    <h1 class="error-ops-panel__title">Error Interno del Servidor</h1>
                </div>
                ...
                <div class="error-ops-panel__content">
                    ...
                    @else
                        <p style="color: #6b7280; font-size: 1.05rem; margin-top: 0.5rem;">
                            Ocurrió un error inesperado en el servidor. El equipo técnico ya fue notificado.
                        </p>
                    @endif

                    <div class="error-support-box">
                        <p>
                            ...
                            <br>
                            • Revisá la consola de errores para más detalles (si tenés acceso).
                        </p>
                    </div>

                    <div class="error-actions">
                        <a href="{{ route('admin.index') }}" class="btn-ops-primary">
                            <i class="fas fa-home"></i> Volver al Inicio
                        </a>
                        <a href="javascript:location.reload()" class="btn-ops-secondary">
                            <i class="fas fa-sync-alt"></i> Reintentar
                        </a>
                        @auth
                        <a href="javascript:history.back()" class="btn-ops-secondary">
            ...
            <div class="error-ops-panel__footer">
                <span style="color: #9ca3af; font-size: 0.85rem;">
                    ...
                    Si el error persiste, contactá al administrador con el código de error y el paso a paso para reproducirlo.
                </span>
            </div>
        </div>
    </div>
