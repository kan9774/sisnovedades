...
@section('subtitle', 'Nuevo Conductor')
...
<div class="container-fluid">
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-user-tie text-primary"></i> Crear Conductor
            </h3>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('lugar_carne_habilitante') }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('tipo_vehiculo_habilitado') }}"
