        ...
        <div class="card card-outline-ops">
            <div class="card-header-ops">
                <div class="card-header-ops__title-wrap">
                    ...
                    <span class="card-header-ops__eyebrow">{{ $guardias->count() }} registros</span>
                </div>
                <div class="card-tools">
                    @can('viewTrashed', App\Models\Guard::class)
                        <a href="{{ route('admin.guardias.trashed') }}" class="btn-ops btn-ops-secondary btn-sm me-1"
                            data-toggle="tooltip" title="Ver guardias eliminadas">
                            <i class="fas fa-trash-alt"></i> Papelera
                        </a>
                    @endcan
                    @can('create', App\Models\Guard::class)
                        <a href="{{ route('admin.guardias.create') }}" class="btn-ops btn-ops-primary btn-sm">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('admin.guardias.show', $guardia) }}"
                                                class="btn-ops btn-ops-info btn-sm mr-2" data-toggle="tooltip"
                                                title="Ver detalles de la guardia">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            @can('update', $guardia)
                                                <a href="{{ route('admin.guardias.edit', $guardia) }}"
                                                    class="btn-ops btn-ops-warning btn-sm ml-1" data-toggle="tooltip"
                                            ...
                                            @can('delete', $guardia)
                                                <form action="{{ route('admin.guardias.destroy', $guardia) }}" method="POST"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="btn-ops btn-ops-danger btn-sm" data-toggle="tooltip"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-5">
                                        ...
                                        @can('create', App\Models\Guard::class)
                                            <br>
                                            <a href="{{ route('admin.guardias.create') }}" class="btn-ops btn-ops-primary btn-sm mt-2">
