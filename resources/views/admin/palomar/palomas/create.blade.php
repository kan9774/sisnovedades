...
@section('content_body')
    <div class="container-fluid">
        ...
        <x-ops-card icon="dove" title="Nueva Paloma">
            <x-slot:actions>
                <a href="{{ $palomarId ? route('admin.palomares.show', $palomarId) : route('admin.palomas.index') }}"
                    class="btn-ops btn-ops-secondary" aria-label="Cancelar y volver">
            ...
            <form action="{{ route('admin.palomas.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="anilla">
                                <i class="fa-solid fa-hashtag text-muted mr-1"></i> Anilla <span
                                    class="text-danger">*</span>
                            </label>
                            <input type="text" name="anilla" id="anilla" autocomplete="anilla"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="raza" id="raza" autocomplete="raza"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="origen" id="origen" autocomplete="origen"
                                class="form-control @error('origen') is-invalid @enderror" value="{{ old('origen') }}"
