...
@section('subtitle', 'Editar Estado')
@section('content_header_title', 'Estados')
@section('content_header_subtitle', 'Editar: ' . $estado->nombre)

@section('content_body')
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-tag"></i> Editar Estado</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.estados-paloma.update', $estado) }}" method="POST">
                    @csrf @method('PUT')
