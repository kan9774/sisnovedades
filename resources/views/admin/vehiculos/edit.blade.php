                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="tipo_combustible"
                                ...
                                <option value="gas_oil" {{ old('tipo_combustible', $vehiculo->tipo_combustible) == 'gas_oil' ? 'selected' : '' }}>
                                    Gas Oil
                                </option>
                                <option value="nafta" {{ old('tipo_combustible', $vehiculo->tipo_combustible) == 'nafta' ? 'selected' : '' }}>
                                    Nafta
                                </option>
                            </select>
