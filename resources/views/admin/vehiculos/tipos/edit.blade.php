...
@section('subtitle', 'Editar Tipo de Vehículo')
@section('content_header_title', 'Vehículos')
@section('content_header_subtitle', 'Tipos - Editar')
...
<div class="container-fluid">
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-shapes text-primary"></i> Editar Tipo: <strong>{{ $tipoVehiculo->nombre }}</strong>
            </h3>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.vehiculos.tipos.update', $tipoVehiculo) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-switch">
                                <input type="checkbox"
                                       ...
                                       id="activo"
                                       name="activo"
                                       {{ old('activo', $tipoVehiculo->activo) ? 'checked' : '' }}>
