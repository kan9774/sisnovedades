...
<li class="nav-item dropdown user-menu">
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
        {{-- Avatar del usuario --}}
        @if ($user->avatar)
            <img src="{{ asset('storage/' . $user->avatar) }}" class="user-image img-circle elevation-2" alt="Avatar"
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-header"
            style="background: #343a40; color: #fff; padding: 20px 15px 15px; border-radius: 4px 4px 0 0;">
            @if ($user->avatar)
                <img src="{{ asset('storage/' . $user->avatar) }}" class="img-circle elevation-2" alt="Avatar"
        ...
        <li class="user-footer"
            style="background: #f8f9fa; padding: 12px 15px; border-radius: 0 0 4px 4px; display: flex; justify-content: space-between; gap: 8px;">
            <a href="{{ route('home') }}" class="btn btn-default btn-flat btn-sm"
                style="border: rgb(45, 113, 214) 1px solid; flex: 1;">
                <i class="fas fa-home"></i> Inicio
            </a>
            <a href="{{ route('logout') }}" class="btn btn-default btn-flat btn-sm"
                style="border: 1px solid #790505; flex: 1; text-align: center;"
