...
<div style="display: contents;">
    ...
    {{-- ============================================================
    TOPBAR MÓVIL — solo visible <992px, dispara el
        off-canvas============================================================--}} <div class="mobile-topbar">
...
<aside class="sidebar">
    ...
    <div class="dropup px-3">
        <a href="#" class="sidebar-user-notif d-flex align-items-center" id="notifDropdown" role="button"
            ...
            <span class="ml-2"
                style="font-family: var(--font-mono); font-size: 0.7rem; letter-spacing: 0.06em; text-transform: uppercase;">
                Notificaciones
            </span>
            @if ($totalNoLeidas > 0)
    ...
    <div class="dropup">
        <div class="sidebar-user dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown"
            ...
            @if (Auth::user()->avatar)
            <img src="{{ asset('storage/' . Auth::user()->avatar) }}" class="img-circle elevation-1" alt="Avatar"
