        ...
        <div x-show="!$wire.showPanel && $wire.vista === 'lista'" x-transition>
            @if ($guardias->count() > 0)
                <div class="ops-doc-grid">
                    @foreach ($guardias as $guardiaItem)
                        <article class="ops-doc-card ops-guardia-card" wire:key="guardia-card-{{ $guardiaItem->id }}">
                            ...
                            <div class="ops-doc-card__body">
                                <h3 class="ops-doc-card__titulo">
                                    Guardia del {{ $guardiaItem->date->format('d/m/Y') }}
                                </h3>
