        ...
        <div class="ops-modal ops-modal--lg">
            <form wire:submit="guardar">
                <div class="ops-modal__header">
                    ...
                    <button type="button" class="ops-modal__close" onclick="cerrarOpsModal('modalEditarNovedad-{{ $novedad->id }}')" title="Cerrar">
                ...
                <div class="ops-modal__footer">
                    <button type="button" class="btn btn-outline-secondary" onclick="cerrarOpsModal('modalEditarNovedad-{{ $novedad->id }}')">Cancelar</button>
                    <button type="submit" class="btn ops-modal__save-btn" wire:loading.attr="disabled" wire:target="guardar">
