<div>
    {{-- ALERTAS GLOBALES --}}
    @if ($successMsg)
        <div wire:key="success-{{ md5($successMsg) }}" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => { show = false; $wire.set('successMsg', '') }, 4000)" x-transition class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    @if ($errorMsg)
        <div wire:key="error-{{ md5($errorMsg) }}" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => { show = false; $wire.set('errorMsg', '') }, 5000)" x-transition class="alert alert-danger alert-dismissible fade show" role="alert">
        ...
        <div class="row mb-3">
            <div class="col-md-8">
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search" class="form-control border-left-0" placeholder="Buscar por matrícula, marca, modelo o vehículo...">
                </div>
            </div>
    ...
    <div class="ops-panel-overlay" id="modalVehiculo"
         x-data
        ...
        <div class="ops-panel">
            <div class="ops-panel__form">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="formMatricula" class="form-control form-control-sm @error('formMatricula') is-invalid @enderror" placeholder="Ej: AA-BB-123">
                                            @error('formMatricula')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Marca</label>
                                            <input type="text" wire:model="formMarca" class="form-control form-control-sm @error('formMarca') is-invalid @enderror" placeholder="Ej: Ford">
                                            @error('formMarca')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Modelo</label>
                                            <input type="text" wire:model="formModelo" class="form-control form-control-sm @error('formModelo') is-invalid @enderror" placeholder="Ej: F-150">
                                            @error('formModelo')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Vehículo</label>
                                            <input type="text" wire:model="formVehiculo" class="form-control form-control-sm @error('formVehiculo') is-invalid @enderror" placeholder="Identificador interno">
                                            @error('formVehiculo')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model="formNumeroChasis" class="form-control form-control-sm @error('formNumeroChasis') is-invalid @enderror" placeholder="Número de chasis">
                                            @error('formNumeroChasis')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Nº Motor</label>
                                            <input type="text" wire:model="formNumeroMotor" class="form-control form-control-sm @error('formNumeroMotor') is-invalid @enderror" placeholder="Número de motor">
                                            @error('formNumeroMotor')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Ejes <span class="text-danger">*</span></label>
                                            <input type="number" wire:model="formEjes" min="1" max="10" class="form-control form-control-sm @error('formEjes') is-invalid @enderror">
                                            @error('formEjes')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Estado <span class="text-danger">*</span></label>
                                            <select wire:model="formEstado" class="form-control form-control-sm @error('formEstado') is-invalid @enderror">
                                            ...
                                            @error('formEstado')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="formDescripcion" rows="2" class="form-control form-control-sm @error('formDescripcion') is-invalid @enderror" placeholder="Observaciones sobre el vehículo..."></textarea>
                            ...
                            <x-ops-card title="Catálogos" icon="th-list" class="mt-3">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Unidad</label>
                                            <select wire:model="formUnidadId" class="form-control form-control-sm @error('formUnidadId') is-invalid @enderror">
                                                <option value="">-- Seleccionar --</option>
                                                @foreach ($catalogos['unidades'] as $unidad)
                                                    <option value="{{ $unidad->id }}">{{ $unidad->nombre }}</option>
                                                @endforeach
                                            </select>
                                            @error('formUnidadId')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Tipo de Vehículo</label>
                                            <select wire:model="formTipoVehiculoId" class="form-control form-control-sm @error('formTipoVehiculoId') is-invalid @enderror">
                                                <option value="">-- Seleccionar --</option>
                                                @foreach ($catalogos['tiposVehiculo'] as $tipo)
                                                    <option value="{{ $tipo->id }}">{{ $tipo->nombre }}</option>
                                                @endforeach
                                            </select>
                                            @error('formTipoVehiculoId')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select wire:model="formTipoCombustibleId" class="form-control @error('formTipoCombustibleId') is-invalid @enderror">
                                                    <option value="">-- Seleccionar --</option>
                                            ...
                                            @error('formTipoCombustibleId')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select wire:model="formTipoLubricanteId" class="form-control @error('formTipoLubricanteId') is-invalid @enderror">
                                                    <option value="">-- Seleccionar --</option>
                                            ...
                                            @error('formTipoLubricanteId')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select wire:model="formTipoRodadoId" class="form-control @error('formTipoRodadoId') is-invalid @enderror">
                                                    <option value="">-- Seleccionar --</option>
                                            ...
                                            @error('formTipoRodadoId')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                </div>
                            </x-ops-card>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" wire:model="formConsumoLitrosPorKm" step="0.0001" min="0" max="999.9999" class="form-control form-control-sm @error('formConsumoLitrosPorKm') is-invalid @enderror" placeholder="Ej: 0.1500">
                                            @error('formConsumoLitrosPorKm')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group pt-4">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="formSinCuentakilometros" wire:model="formSinCuentakilometros">
                                                <label class="custom-control-label" for="formSinCuentakilometros">Sin cuenta kilómetros</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group pt-4">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="formActivo" wire:model="formActivo"
                                                ...
                                                @if (in_array($formEstado, ['rojo', 'negro']))
                                                    <small class="text-muted d-block mt-1">
                                                        <i class="fas fa-info-circle"></i> Se desactiva automáticamente porque el estado es {{ $formEstado }}.
                                                    </small>
                                                @endif
                                            </div>
                                        </div>
                                                ...
                                                <tbody>
                                                    @foreach ($formActasExistentes as $acta)
                                                        <tr wire:key="acta-{{ $acta['id'] }}">
                                                            <td>
                                                                <a href="{{ Storage::url($acta['path']) }}" target="_blank">
                                                                    <i class="fas fa-file-pdf"></i> {{ $acta['nombre_original'] }}
                                                                </a>
                                                            </td>
                                                            <td>{{ round($acta['tamano_bytes'] / 1048576, 2) }} MB</td>
                                            ...
                                            <table class="table table-sm table-hover mb-0">
                                                ...
                                                <tbody>
                                                    @foreach ($queuedActaPaths as $index => $acta)
                                                        <tr wire:key="queued-{{ $index }}-{{ $acta['path'] }}">
                                                            <td>
                                                                <i class="fas fa-file-pdf"></i> {{ $acta['nombre_original'] }}
                                                            </td>
                                                            <td>{{ round($acta['tamano_bytes'] / 1048576, 2) }} MB</td>
                                    ...
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-sm btn-outline-primary mb-2"
                                            ...
                                            <template x-if="subiendo">
                                                <span><span class="spinner-border spinner-border-sm mr-1"></span> Subiendo...</span>
                                            </template>
                                            <template x-if="!subiendo">
                                        ...
                                        <input type="file" x-ref="fileInput" hidden
                                            ...
                                            ">
                                        <small class="text-muted d-block">Máximo 5 archivos, 10MB en total entre todos. Formatos: PDF, imágenes, DOC.</small>
                                        <small class="text-danger d-block mt-1" x-show="errorLocal" x-text="errorLocal"></small>
                                    </div>
                                </div>
                            </x-ops-card>
                ...
                <div class="ops-panel__footer">
                    <button type="button" class="btn btn-outline-secondary" wire:click="cerrarForm" wire:loading.attr="disabled" wire:target="guardar" @disabled($loading)>
                        Cancelar
                    </button>
                    <button type="submit" form="form-vehiculo" class="btn btn-ops-primary" wire:loading.attr="disabled" wire:target="guardar" @disabled($loading)>
                        @if ($loading)
    ...
    <template x-teleport="body">
    <div class="ops-panel-overlay" id="modalDetalleVehiculo"
         x-data
                    ...
                    <div class="ops-panel__content">
                        @if ($detalleVehiculo)
                            ...
                            <ul class="nav nav-tabs nav-tabs-ops mb-3" id="detalleTabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link nav-link-ops" data-toggle="tab" href="#detalleMantenimientos">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="conductor-section">
                                                ...
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-id-card"></i> Matrícula</span>
                                                    <span class="conductor-field__value fw-bold">{{ $detalleVehiculo->matricula }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-truck"></i> Marca / Modelo</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->marca ?? '—' }} {{ $detalleVehiculo->modelo ?? '' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-hashtag"></i> Vehículo</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->vehiculo ?? '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-barcode"></i> Nº Chasis</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->numero_chasis ?? '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-cog"></i> Nº Motor</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->numero_motor ?? '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-arrows-alt-v"></i> Ejes</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->ejes }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-flag"></i> Estado</span>
                                                    <span class="conductor-field__value">
                                                        <span class="{{ $detalleVehiculo->estado_badge_class }}">{{ $detalleVehiculo->estado_label }}</span>
                                                    </span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-check-circle"></i> Activo</span>
                                                    <span class="conductor-field__value">
                                                ...
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-align-left"></i> Descripción</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->descripcion }}</span>
                                                </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="conductor-section">
                                                ...
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-building"></i> Unidad</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->unidad->nombre ?? '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-truck"></i> Tipo Vehículo</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->tipoVehiculo->nombre ?? '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-gas-pump"></i> Tipo Combustible</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->tipoCombustible->nombre ?? '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-oil-can"></i> Tipo Lubricante</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->tipoLubricante->nombre ?? '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-circle"></i> Tipo Rodado</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->tipoRodado->nombre ?? '—' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="conductor-section">
                                                ...
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-tachometer-alt"></i> Consumo (L/km)</span>
                                                    <span class="conductor-field__value">{{ $detalleVehiculo->consumo_litros_por_km ? number_format($detalleVehiculo->consumo_litros_por_km, 4) : '—' }}</span>
                                                </div>
                                                <div class="conductor-field">
                                                    <span class="conductor-field__label"><i class="fas fa-tachometer-alt"></i> Sin cuenta kilómetros</span>
                                                    <span class="conductor-field__value">
                                        ...
                                        <div class="col-md-6">
                                            <div class="conductor-section">
                                                ...
                                                @if ($detalleVehiculo->actas && $detalleVehiculo->actas->count() > 0)
                                                    ...
                                                    <div class="conductor-field">
                                                        <span class="conductor-field__label"><i class="fas fa-file-pdf"></i> {{ $acta->nombre_original }}</span>
                                                        <span class="conductor-field__value">
                                                            <a href="{{ Storage::url($acta->path) }}" target="_blank">
                                                                <i class="fas fa-download"></i> Descargar ({{ number_format($acta->tamano_bytes / 1048576, 2) }} MB)
                                                            </a>
                                                        </span>
                                                    </div>
                                                    @endforeach
                                                @else
                                                <div class="conductor-field">
                                                    <span class="conductor-field__value text-muted">Sin actas registradas.</span>
                                                </div>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="detalleSalidas">
                                        ...
                                        @foreach ($detalleVehiculo->salidas as $salida)
                                            <div class="salida-card">
                                                ...
                                                <div class="salida-card__info">
                                                    <h6>{{ $salida->conductor?->primer_apellido ?? 'N/A' }}{{ $salida->conductor?->primer_nombre ?? '' }}</h6>
                                                    <small>
                                    ...
                                    @else
                                        <div class="text-center py-4">
                                            ...
                                            <p class="text-muted mb-0">No se registran salidas recientes para este vehículo.</p>
                                        </div>
                                    @endif
                                </div>

                                {{-- TAB: Últimos Mantenimientos --}}
                                <div class="tab-pane" id="detalleMantenimientos">
                                    @if ($detalleVehiculo->mantenimientos && $detalleVehiculo->mantenimientos->count() > 0)
                                        <div class="table-responsive">
                                            <table class="table table-sm table-hover">
                                                ...
                                                <tbody>
                                                    @foreach ($detalleVehiculo->mantenimientos as $mant)
                                                        <tr>
                                                            <td>{{ $mant->fecha->format('d/m/Y') }}</td>
                                                            <td>{{ $mant->tipo ?? '—' }}</td>
                                                            <td>{{ $mant->descripcion ?? '—' }}</td>
                                                            <td>{{ $mant->kilometros ? number_format($mant->kilometros, 0) : '—' }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                    ...
                                    @else
                                        <div class="text-center py-4">
                                            <i class="fas fa-wrench fa-2x text-muted d-block mb-2"></i>
                                            <p class="text-muted mb-0">No se registran mantenimientos para este vehículo.</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="ops-panel__footer">
                    <div style="display: flex; justify-content: flex-end; gap: .5rem;">
                        ...
                        @if ($detalleVehiculo && auth()->user()->can('update', $detalleVehiculo))
                            <button type="button" class="btn btn-ops-primary" wire:click="abrirEditarDesdeDetalle">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        ...
                        <button type="button" class="close text-white" wire:click="$set('confirmDeleteId', null)">&times;</button>
                    </div>
                    <div class="modal-body">
                        <p>¿Estás seguro de que deseas eliminar este vehículo?</p>
                        <p class="text-muted mb-0"><small>Esta acción eliminará también los archivos de acta asociados si existen.</small></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" wire:click="$set('confirmDeleteId', null)">
                            Cancelar
                        </button>
                        <button type="button" class="btn btn-danger" wire:click="ejecutarEliminacion" @disabled($loading)>
                            @if ($loading)
