<div class="d-inline">
    <button type="button" class="btn btn-primary btn-ml ml-1" wire:click="abrir" data-toggle="tooltip"
        ...
        style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); box-shadow: 0 2px 8px rgba(59, 130, 246, 0.3); border: none;">
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content" style="backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px);">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="enviar" wire:loading.attr="disabled"
                        wire:target="enviar"
                        style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%) !important; box-shadow: 0 2px 8px rgba(59, 130, 246, 0.3) !important;">
