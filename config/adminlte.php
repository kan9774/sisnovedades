    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text'   => 'Vencidos en Terceros',
                    'url'    => 'admin/inventario/vencidos-terceros',
                    'icon'   => 'fa-solid fa-triangle-exclamation',
                    'active' => ['admin/inventario/vencidos-terceros*'],
                    'can'    => 'viewAny-lote',
                ],
                [
                    'text'   => 'Historial de Entregas',
                    'url'    => 'admin/inventario/entregas/historial',
                    'icon'   => 'fa-solid fa-clock-rotate-left',
                    'active' => ['admin/inventario/entregas/historial*'],
                    'can'    => 'viewAny-entrega',
                ],
            ],
        ],
